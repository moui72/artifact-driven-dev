...
| Install for OpenAI Codex CLI (or alongside Claude Code) | `./install.sh --harness codex <project>` — skills land in `.agents/skills/`, invoked as `$ardd-*` | [install.md](docs/install.md#codex-cli-installsh---harness-codex) |
