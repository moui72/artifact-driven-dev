...
1 open (mine — a second file on disk,
...
see In Flight-adjacent note in the `_Updated` history above).
`feedback-new-sh-codex-launch-tty-b951.md` and
`feedback-ardd-backlog-codex-syntax-1c0f.md` are both now `planned`,
consumed by `plan-b860-2026-07-22-e518.md` and
`plan-35f6-2026-07-22-93b3.md` respectively — see the `_Updated` notes
above. `feedback-scenario-sweep-2026-07-21-d816-0f18.md` (3 bugs + 3 UX
from the full-tier `/scenario-sweep` run 2026-07-21-d816: harness
compat-guard gap in `/ardd-update`, CWD-relative `ardd-scripts` resolution
footgun, reverse-engineered constitution overclaim, unhonorable
TDD-red-first task phrasing, literal `PLACEHOLDER` in the badge snippet,
`/ardd-status`'s missing "0 planned" line — see the `_Updated` note above).
Delivered today: `feedback-new-sh-codex-undocumented-b8f0.md`
...
`/ardd-plan` to consume the remaining open feedback file
(`feedback-scenario-sweep-2026-07-21-d816-0f18.md`, 6 items). Also
standing: `/ardd-defects` to refresh the
