...
created: 2026-07-11
plan: plan-primary-stays-on-main-2026-07-11.md
---

# Feedback

## Bugs
- [x] F001 During the 2026-07-11 npx-scrap implementation, a T005 commit
...
## Reconsidered
- [x] F002 The primary/default worktree of THIS repo must **never leave
...
- [x] F003 All feature work in this repo happens in a **separate git
...
- [x] F004 Possible generalization (decide during planning, do not assume):
