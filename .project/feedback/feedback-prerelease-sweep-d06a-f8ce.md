...
- [x] F001 (S3-F003) `/ardd-update --stable` on a real consumer today
  ...
  cutting v1.0.1.
- [x] F002 (S3-F001) `scripts/parallel-matrix.sh` reports
...
- [x] F003 (S6-F001) When the same tasks file appears as
...
- [x] F004 (S5-F001) `skills/ardd-status/SKILL.md`'s Work Queue prose
