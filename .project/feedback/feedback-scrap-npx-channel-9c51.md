...
## UX
- [ ] F001 The `npx skills add moui72/artifact-driven-dev` install channel
...
## Reconsidered
- [ ] F002 Scrap the `npx skills add` acquisition channel entirely.
...
- [ ] F003 Replace the npx channel with an existing-project curl bootstrap —
...
- [ ] F004 Delete `/ardd-setup` as dead architecture once the npx channel is
