...
- [ ] T005 Sync `skills/ardd-init/SKILL.md` step 5's apply bullet (~line 222): "(or the named subsection, for Pre-commit Enforcement)" → "(or the named subsection, for Deterministic Gates)". Grep the rest of skills/ and docs/ for "Pre-commit Enforcement" and "CI Enforcement" to catch any other stale reference. (F001)
